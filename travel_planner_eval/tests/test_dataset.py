...
from dataset import _record_to_sample
...
def test_sample_input_contains_query(base_record):
    sample = _record_to_sample(base_record, PLANNER_INSTRUCTION)
...
def test_sample_input_uses_cot_instruction():
    sample = _record_to_sample(_BASE_RECORD, COT_PLANNER_INSTRUCTION)
