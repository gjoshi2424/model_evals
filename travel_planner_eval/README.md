...
- Sample size was limited due to cost constraints. For gpt-3.5-turbo-1106 this is likely causing the results to have slightly higher scores than the leader board commensense macro pass rate.
